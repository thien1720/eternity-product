...
function DetailSize() {
    ...
    return <div className={cx("show-detail-size")}>
        <div className={cx("detail-img")}>
            <img src="/eternity/bang_size_ao_thun.webp" alt="size" />

        </div>

        <p>Bảng Size Áo Varsity ETERNITY</p>
        <div className={cx("detail-img-vacity")}>
            <img src="/eternity/bang_size_varsity.webp" atl="size" />
        </div>

        <div className={cx("sub-use-size")}>
            <p>* Hoặc inbox vào page ETERNITY trên FB hoặc IG đề chúng mình có thể tư vấn cho bạn size sản phẩm phù hợp nhất nha. </p>
