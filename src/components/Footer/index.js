                            ...
                            <div className={cx("footer-contact")}>
                                <ul>
                                    <li>
                                        ...
                                        <p>Eternity Bán Tại Website Eternity.blue</p>
                                    </li>
                        ...
                        <div className={cx("footer-content")}>
                            ...
                            <div className={cx("footer-page")}>
                                <div className={cx("style-page")} >
                                    <img src="/eternity/fanpage.png" alt="fanpage"
